...
"""
function parse_cor_file(file_name)
    section = ""
    d = Dict{String,Any}()
    ...
    open(file_name) do f
        for ln in eachline(f)
            ...
            elseif section == "RHS"
                parsemps_rhs!(ln, fields, d, col2idx, row2idx, rhs_row, rhs_val)
...
function parsemps_rhs!(ln, fields, d, col2idx, row2idx, rhs_row, rhs_val)
